...
// console.log(`It will take ${spaceShuttle} ${spaceShuttle.getDaysToLocation(kilometersToMars)} days to get to Mars.`);
// console.log(`It will take ${spaceShuttle} ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days to get to the Moon.`);
